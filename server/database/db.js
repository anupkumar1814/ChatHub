...
const Connection = async () => {
    ...
    const URL = `mongodb://${USERNAME}:${PASSWORD}@ac-emkswwp-shard-00-00.rthlqpe.mongodb.net:27017,ac-emkswwp-shard-00-01.rthlqpe.mongodb.net:27017,ac-emkswwp-shard-00-02.rthlqpe.mongodb.net:27017/?ssl=true&replicaSet=atlas-8q9afy-shard-0&authSource=admin&retryWrites=true&w=majority`
